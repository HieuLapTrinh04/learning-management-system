...
export default function AdminLayout() {
  ...
  const navLinks = [
    { label: 'Bảng điều khiển', to: '/admin/bang-dieu-khien', icon: LayoutDashboard },
    { label: 'Quản lý người dùng', to: '/admin/quan-ly-nguoi-dung', icon: Users },
    { label: 'Quản lý danh mục', to: '/admin/danh-muc', icon: Layers },
    { label: 'Phê duyệt khóa học', to: '/admin/phe-duyet-khoa-hoc', icon: CheckSquare },
